...
QT_MOC_LITERAL(3, 24, 8)
    ...
    "AboutUsDialog\0setinput\0\0getinput\0"
};
...
void AboutUsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AboutUsDialog *_t = static_cast<AboutUsDialog *>(_o);
        switch (_id) {
        case 0: _t->setinput((*reinterpret_cast< QStringList(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (AboutUsDialog::*_t)(QStringList , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AboutUsDialog::setinput)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AboutUsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AboutUsDialog.data,
...
// SIGNAL 0
void AboutUsDialog::setinput(QStringList _t1, int _t2)
{
