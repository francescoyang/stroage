...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sqlinit_signal(); break;
        case 1: _t->changepasswd_signal(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainMenu::sqlinit_signal)) {
                *result = 0;
            }
        }
        {
            typedef void (MainMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainMenu::changepasswd_signal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void MainMenu::sqlinit_signal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void MainMenu::changepasswd_signal()
{
